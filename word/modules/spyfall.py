...
class SpyGame:
    ...
    async def prompt_next_explanation(self):
        ...
        self.explanation_message = await spy.send_message(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("View Word", url=f"t.me/Words_gamer_bot")]])
        )
    ...
    async def start_voting(self):
        ...
        for player in self.players:
            try:
                ...
                pass    
        await spy.send_message(self.chat_id, "🗳️ Voting started! Check PMs!", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Go To Votes", url=f"t.me/Words_gamer_bot")]]))
...
async def join_spy(client, message):
    ...
    try:
        ...
        return await message.reply(
            "❌ Please start the bot in private and unblock it to join the game: [Start Bot](https://t.me/Words_gamer_bot)",
...
async def handle_vote_callback(client, query):
    ...
    try:
        ...
        await spy.send_message(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Go Back", url=f"{chat_link}" if chat_link else "https://t.me/Words_gamer_bot")]
            ])
        )
        await spy.send_message(
            game.chat_id,
